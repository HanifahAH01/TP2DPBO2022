...
$view = new Template('templates/datadivisijabatan.html');
...
while ($div = $divisi->getResult()) {
    ...
    <td style="font-size: 22px;">
        <a href="divisi.php?id=' . $div['divisi_id'] . 
        '" title="Edit Data"><i class="bi bi-pencil-square 
        text-warning"></i></a>&nbsp;<a href="divisi.php?hapus=' . 
        $div['divisi_id'] . '" title="Delete Data"><i class="bi bi-trash-fill text-danger"></i></a>
        </td>
    </tr>';
    $no++;
}
