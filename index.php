    ...
    $data .= '<div class="col gx-2 gy-3 justify-content-center">' .
        ...
        <a href="detail.php?id=' . $row['pengurus_id'] . '">
            ...
            <div class="card-body" style=" align-items: center;">
                <p class="card-text pengurus-nama my-0" style=" align-items: center;">' . $row['pengurus_nama'] . '</p>
                <p class="card-text divisi-nama" style=" align-items: center;">' . $row['divisi_nama'] . '</p>
                <p class="card-text jabatan-nama my-0" style=" align-items: center;">' . $row['jabatan_nama'] . '</p>
            </div>
        </a>
    </div>    
    </div>';
